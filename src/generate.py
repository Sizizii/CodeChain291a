...
model_mapping = {"gpt3.5": "gpt-3.5-turbo-16k","gpt4": "gpt-4","wizard_coder":"WizardLMTeam/WizardCoder-Python-13B-V1.0"}
...
if args.split is not None and args.split == 'mini_val':
    ...
    apps = load_dataset("codeparrot/apps",cache_dir='data')[args.split]
